  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <header className="border-b px-4 md:px-6 py-3 flex items-center gap-4">
        <h1 className="text-lg font-semibold text-foreground">dais-app</h1>
      ...
      <Card className="shadow-lg">
        ...
        <CardContent className="space-y-3">
          <p className="text-sm text-muted-foreground">
            Browse Virtue Foundation facilities by region and specialty, with precomputed link validation.
          </p>
          <div className="flex flex-wrap gap-2">
            <Button asChild>
              <NavLink to="/facilities">Open Facility Browser</NavLink>
            </Button>
            <Button variant="outline" asChild>
              <NavLink to="/analytics">Analytics demo</NavLink>
            </Button>
          </div>
        </CardContent>
      </Card>
